...
let time=obj.test[2];
  ...
  let count=1;
  let sql='INSERT INTO cake_chart (item_name,item_price,item_count,item_address,new_time,item_solor_price) VALUES (?,?,?,?,?,?)';
  console.log(obj.test)
  pool.query(sql,[obj.test[1],obj.test[0],count,obj.test[3],obj.test[4],obj.test[0]],(err,results)=>{
    if(err) throw err;
    res.send({code:obj})
  })
